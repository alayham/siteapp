...
Drupal.settings.site_path = 'http://www.alayham.com'; // e.g. http://www.example.com
...
Drupal.settings.cache.entity.enabled = yes;
Drupal.settings.cache.views.enabled = yes;
...
// App Title
drupalgap.settings.title = 'موقع الأيهم صالح';
 
// App Front Page
drupalgap.settings.front = 'node';
...
drupalgap.settings.offline_message = 'هذا التطبيق يتطلب الاتصال مع الإنترنت';
